...
df_model = @chain df_tokens begin
	...
	reduce(vcat, _)
	unique(_)
	subset(_, :word => ByRow(x -> 3 ≤ sum(x .== _.word)))
...
# ╔═╡ e788f33f-860e-4a9c-96e1-c388789aa2ca
model = hotones(W, S, Y)
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "168d6ca5765523f9fe9933179107bbac062831fb"
